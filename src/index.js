...
function calculator(number = 0) {
    ...
    return {
        sum: (...args) => args.reduce((accum, curentValue) => accum + curentValue, number),
        dif: (...args) => args.reduce((accum, curentValue) => accum - curentValue, number),
        div: (...args) => args.reduce((accum, curentValue) => {
            if (curentValue === 0) {
        ...
        mul: (...args) => args.reduce((accum, curentValue) => accum * curentValue, number)
    }
}
